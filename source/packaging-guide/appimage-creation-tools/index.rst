...
The so-called *excludelist* of all core libraries that aren't included by most AppImage creation tools is available `here <https://github.com/AppImageCommunity/pkg2appimage/blob/master/excludelist>`__.
